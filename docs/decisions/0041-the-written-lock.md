...
no merge tooling ships. the union behaviour of entry lines is a property of the format, and a git driver that exploits it is future tooling rather than a format concern.
